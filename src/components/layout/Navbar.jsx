...
const Navbar = ({ onMenuClick }) => {
    ...
    const logoVariants = {
        ...
        visible: { scale: 1, rotate: 0, transition: { type: 'spring', bounce: 0.4, duration: 0.6 } }
    };
                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <Link to="/" className="flex items-center space-x-2 group">
                        <motion.div
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-10 h-10 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 flex items-center justify-center shadow-md group-hover:shadow-lg transition-all"
                        >
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <motion.button
                            ...
                            className="p-2 rounded-lg hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors text-gray-600 dark:text-gray-300"
                        ...
                        {isAuthenticated ? (
                            <div className="relative">
                                <motion.button
                                    ...
                                    className="flex items-center space-x-2 p-1.5 rounded-lg hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors"
                                >
                                    <div className="w-9 h-9 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 flex items-center justify-center text-white font-semibold text-sm shadow-md">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                >
                                    <Link
                                        to="/register"
                                        className="px-4 py-2 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold text-sm shadow-md hover:shadow-lg transition-all"
                                    >
                                        Register
                                    </Link>
                                </motion.div>
                            ...
                            <div className="py-4 border-t border-amber-200/50 dark:border-gray-700">
                                <div className="space-y-2">
                                    ...
                                    <div className="pt-2 border-t border-amber-200/50 dark:border-gray-700">
                                        <Link to="/dashboard" className="block px-2 py-2 text-gray-700 dark:text-gray-300 hover:text-amber-600" onClick={() => setIsMenuOpen(false)}>
                                            📊 Dashboard
                                        </Link>
                                        <button onClick={() => { handleLogout(); setIsMenuOpen(false); }} className="block w-full text-left px-2 py-2 text-red-600">
